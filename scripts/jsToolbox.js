...
Element.prototype.toggleClassName = function(classString) {
    console.log("toggling");
    console.log(this.hasClassName(classString));
    if (this.hasClassName(classString)) {
        this.removeClassName(classString);
    }
    else {
        this.addClassName(classString);
    }
    return true;
};
